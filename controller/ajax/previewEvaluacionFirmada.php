...
if (!$registro || $registro['tipo'] !== 'evaluacion_unidad_productiva') {
...
$coordPath = $base . DIRECTORY_SEPARATOR . 'storage' . DIRECTORY_SEPARATOR . 'generated'
           . DIRECTORY_SEPARATOR . 'evaluacion_unidad_productiva_coordinates.json';
$campos    = [];
$firmaConf = null;
$selloConf = null;
...
try {
            ...
            if ($sealImgPath) {
                ...
                if ($info && $info[0] > 0) {
                    if ($selloConf && isset($selloConf['x'], $selloConf['y'])) {
                        ...
                        $sealY = $pageH - 62.0 - ($sealW * ($info[1] / $info[0]));
                    }
    ...
    $pdf->Output('I', 'preview_evaluacion_firmada.pdf');
