  ...
  <div id="alertBox"></div>
    ...
    <form class="col-md-12" id="cfgForm" onsubmit="return false;">
        ...
        <div class="form-section">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="color" class="form-control form-control-color" id="header_bar_color" value="#01643d">
                </div>

                <!-- Logo superior: FILE + hidden -->
                <div class="col-md-4">
                ...
                <div class="col-md-3">
                    <label class="form-label">Meta línea (bajo logo)</label>
                    <input type="text" class="form-control" id="header_meta_line"
                        placeholder="Universidad Montrer · Morelia, Mich.">
                </div>
        ...
        <div class="form-section">
            ...
            <div class="row g-3">
                <div class="col-md-3"><label class="form-label">Color barra inferior</label><input type="color"
                        class="form-control form-control-color" id="footer_bottom_bar_color" value="#01643d"></div>

                <!-- Logo pie: FILE + hidden -->
                <div class="col-md-4">
                ...
                <div class="col-md-2"><label class="form-label">Ancho logo pie (px)</label><input type="number"
                        class="form-control" id="layout_footer_logo_width" value="140" min="50"></div>
                <div class="col-md-3"><label class="form-label">Contacto</label><input type="text" class="form-control"
                        id="footer_contact_line" placeholder="Tel. 52 (443) 324 0439 · contacto@unimontrer.edu.mx">
                </div>
                <div class="col-md-12"><label class="form-label">Texto barra inferior</label><input type="text"
                        class="form-control" id="footer_bottom_text"
                        value="UNIVERSIDAD MONTRER · Universidad en movimiento · www.unimontrer.edu.mx"></div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="row g-3">
                <div class="col-md-3"><label class="form-label">Fuente</label><input type="text" class="form-control"
                        id="layout_font_family" value="Arial, Helvetica, sans-serif"></div>
                <div class="col-md-2"><label class="form-label">Tamaño (pt)</label><input type="number"
                        class="form-control" id="layout_font_size_pt" value="12" min="8"></div>
                <div class="col-md-2"><label class="form-label">Padding contenido (px)</label><input type="number"
                        class="form-control" id="layout_content_padding_px" value="28" min="0"></div>
                <div class="col-md-2"><label class="form-label">Margen página (px)</label><input type="number"
                        class="form-control" id="layout_page_margin_px" value="0" min="0"></div>
            </div>
        </div>
    </form>
